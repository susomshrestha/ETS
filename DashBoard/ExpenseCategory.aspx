<%@ Page Title="" Language="C#" MasterPageFile="~/DashBoard/MasterDashboard.master" AutoEventWireup="true" CodeFile="ExpenseCategory.aspx.cs" Inherits="DashBoard_ExpensesCategory" %>
        ...
        <ContentTemplate>
            <div>
                <p style="margin: 10px 15px;">
                    <a href="Dashboard.aspx">Dashboard </a> / Expense / Add Category
                </p>
            </div>
            <div class="col-lg-12">
                <!--Accordion wrapper-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-header" role="tab" id="headingOne">
                            <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h5 class="mb-0">Add Expense Category <i class="fa fa-angle-down rotate-icon"></i>
                                </h5>
                            </a>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="block">
                    ...
                    <asp:GridView ID="gridExpenseCategories" DataKeyNames="expenseCatId"
                        EmptyDataText="No Data Available"
                        CssClass="table table-hover table-responsive-md table-fixed"
                        runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        OnPageIndexChanging="gridExpenseCategories_PageIndexChanging">
                        <Columns>
